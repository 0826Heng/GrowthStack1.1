...
def _register_default_tools(protocol_handler: ProtocolHandler) -> None:
    ...
    # Agent extension: atomic search tools + agent_query
    from src.mcp_server.tools.keyword_search import register_tool as register_keyword_search
    register_keyword_search(protocol_handler)
    from src.mcp_server.tools.semantic_search import register_tool as register_semantic_search
    register_semantic_search(protocol_handler)
    from src.mcp_server.tools.agent_query import register_tool as register_agent_query
    register_agent_query(protocol_handler)
